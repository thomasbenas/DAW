...
<div class="container">
    <div class="lists">
        <div class="list">
            ...
            <img class="list-img" src="//localhost/assets/images/online-courses.svg" alt="">
        </div>
        ...
        <div class="list">
            ...
            <img class="list-img" src="//localhost/assets/images/code.svg" alt="">
        </div>
        ...
        <div class="list">
            ...
            <img class="list-img" src="//localhost/assets/images/book.svg" alt="">
        </div>
    </div>
